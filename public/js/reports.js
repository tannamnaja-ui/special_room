...
const REPORTS_CONFIG = {
  ...
  'rooms-revenue': {
    ...
    desc: 'จำนวนวันนอนทั้งหมด และรายได้รวมของแต่ละห้อง (นับจากวันที่อยู่ในเตียงพิเศษจริง)',
    endpoint: '/api/reports/rooms-revenue',
    render: renderRoomsRevenueReport,
    note: 'จำนวนวันนอนนับจากวันที่ผู้ป่วยอยู่ในเตียงพิเศษนั้นจริง ตามประวัติการย้ายเตียง (iptbedmove) แบบไม่นับวันซ้ำ — ถ้าเลือกช่วงวันที่ จะนับเฉพาะวันที่อยู่ในช่วงนั้น'
  },
  'total-revenue': {
